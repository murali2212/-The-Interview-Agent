...
**Not yet built:** voice. Deepgram STT → `director.turn()` → Cartesia TTS over
LiveKit. The engine is already shaped for it — `turn()` is transport-agnostic
and every reply is speakable.
